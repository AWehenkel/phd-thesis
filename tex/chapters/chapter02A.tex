...
\begin{chapter_outline}
  ...
  This chapter shall motivate probabilistic modelling in the context of artificial intelligence. We argue that accounting for uncertainty is crucial for building useful models. Our aim is to vulgarise the \textit{probabilistic modelling} framework. We shall convince the reader that this framework enables effective abstract reasoning, and also solve real-world problems.
