...
At a higher level, this chapter has demonstrated another benefit of combining probabilistic models: generalisation capabilities that defy results from a naive interpretation of learning theory. Over the past few years, expert models have shifted from black-box languages (e.g., C, C++, Matlab) to differentiable probabilistic frameworks. In this context, we anticipate excellent opportunities for hybrid learning. This transition shall streamline interactions between deep probabilistic and expert models. This paradigm motivates further theoretical and practical developments in hybrid learning. For instance, developing new algorithms and the corresponding conditions under which the hybrid model outperforms data-driven solutions is a relevant goal to help practitioners solve real-world problems with hybrid models.
