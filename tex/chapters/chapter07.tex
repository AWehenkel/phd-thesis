...
\begin{figure}[h]
  ...
  \caption{An old painting of Isaac Newton writing the theory of gravity in the language of probability and questioning the role of models in the world. As seen by $\text{DALL}\cdot\text{E }2$.}
  \label{}
\end{figure}
