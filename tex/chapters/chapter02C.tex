...
This chapter comprehensively reviews various strategies to parameterise probabilistic models with neural networks. We aim to show how different classes of deep probabilistic models relate to each other. We shall convince the reader of the effectiveness and flexibility of deep probabilistic models. We also provide the primary motivations for the contributions presented in this thesis.
\end{chapter_outline}
