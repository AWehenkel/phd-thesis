...
Combining auto-encoders and other probabilistic models has not waited diffusion models to appear. In particular, similarly to Stable diffusion, VQ-VAE~\citep{razavi2019generating, razavi2019generating2} achieved state-of-the-art image synthesis by combining a classical auto-encoder with an autogressive model to encode the latent variables distribution.
