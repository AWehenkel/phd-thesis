...
\end{chapter_outline}
\section{Prologue}
In this chapter, we bring evidence from which we guess different (deep) probabilistic models shall not be studied independently. Building a broad and deep understanding of all these frameworks unlocks many model combinations. These combinations may help reduce the weaknesses of each class of models separately while maintaining the separate assets of each class.
