...
\subsection{Definition of a probabilistic models}
...
The main goal of building a probabilistic model it to perform \texti{inference}. That is to answer questions in the context of the models. These questions can come with different flavour that can have an impact of the form of model we use. 
...
\subsection{Learning is inference}
