...
where $\mathcal{N}(0, I)$ denotes a normal distribution. \textcolor{red}{Explain why KL in this direction.}
...
\textcolor{red}{Improve with an example.}
