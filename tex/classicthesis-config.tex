...
\colorlet{LightBlue}{White!99!Maroon}

\newenvironment{side_note}[1]
{\centering
	\begin{tcolorbox}[float,width=.9\textwidth,title={#1}
	    ,enhanced jigsaw, pad at break*=1mm, breakable,
	    left=3mm, right=5mm, top=1mm, bottom=1mm,
	    colback=LightBlue, boxrule=0pt, frame hidden,
	    borderline west={0.1mm}{0mm}{Maroon},
	    borderline east={0.1mm}{0mm}{Maroon},
	    borderline south={0.1mm}{0mm}{Maroon}, arc=.0mm, coltitle=white, colbacktitle=Maroon]
	\small
}
{
\end{tcolorbox}
