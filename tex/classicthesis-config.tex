...
% ****************************************************************************************************
\newcommand{\myTitle}{Contributions to Generative Modeling\xspace}
\newcommand{\mySubtitle}{From Deep Models to Hybrid Approaches}
...
\colorlet{LightBlue}{White!85!Maroon}

\newenvironment{side_note}[1]
{
	\begin{tcolorbox}[breakable,width=\textwidth,colback={gray},title={#1}
	    ,enhanced jigsaw, pad at break*=1mm, breakable,
	    left=4mm, right=4mm, top=5mm, bottom=5mm,
	    colback=LightBlue, boxrule=0pt, frame hidden,
	    borderline west={0.5mm}{0mm}{Maroon}, arc=.5mm, coltitle=white, colbacktitle=Maroon]
	\small
}
{
\end{tcolorbox}
...
{
\begin{tcolorbox}[breakable,width=\textwidth,colback={gray},title={\large Outline}
		,enhanced jigsaw, pad at break*=1mm, breakable,
